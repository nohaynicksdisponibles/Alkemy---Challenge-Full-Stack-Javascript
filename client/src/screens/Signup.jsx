        ...
        <div className="flex flex-col items-center w-3/4 sm:w-1/2 my-4 rounded-lg shadow-lg bg-white z-10">
            ...
            <div>
                <div>
                    ...
                    <input placeholder="name" className="border-2 border-purple-400 rounded-lg" type="text" id="name"></input>
                </div>
                ...
                <div className="flex justify-center mt-4">
                    <input className="text-white bg-purple-400 rounded-lg px-4 py-2 cursor-pointer" type="submit" value="Sign Up" onClick={send}></input>
                </div>           
            </div>
        </div>
    </div>
