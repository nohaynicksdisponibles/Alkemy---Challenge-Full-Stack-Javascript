...
function Signup(){
    ...
    function send(){
        ...
        if(mail.trim().length===0 || password.trim().length===0 || name.trim().length===0){
    ...
    return(
        <div className="flex justify-center h-screen relative bg-purple-400">
        ...
        <div className="flex flex-col items-center w-3/4 sm:w-1/2 my-4 rounded-lg shadow-lg bg-white z-10">
            ...
            <div>
                <div>
                    ...
                    <input placeholder="name" className="mt-2 border-2 border-purple-400 rounded-lg" type="text" id="name"></input>
                </div>
                ...
                <div>
                    ...
                    <input placeholder="example@hotmail.com" className="mt-2 border-2 border-purple-400 rounded-lg" type="text" id="mail"></input>
                </div>
                ...
                <div>
                    ...
                    <input placeholder="password" className="mt-2 border-2 border-purple-400 rounded-lg" type="password" id="password"></input>
                </div>
                
                <div className="flex justify-center mt-2">
                    <input className="text-white bg-purple-400 rounded-lg px-4 py-2 mt-4 cursor-pointer" type="submit" value="Sign Up" onClick={send}></input>
                </div>           
            </div>
        </div>
    </div>
